...
void CglicScene::applyTransformation()
{
  ...
  //???????????????????????????????????????????????????????????????????????????????????????????????
  //Besoin de modifier ça??????????????????????????????????????????????????????????????????????????
  //???????????????????????????????????????????????????????????????????????????????????????????????
  //for (int iObj = 0; iObj < listObject.size(); iObj++){
    //listObject[iObj]->MODEL = glm::translate(listObject[iObj]->MODEL, tr);
    //listObject[iObj]->MODEL = glm::rotate(listObject[iObj]->MODEL, transform.hAngle, m_up);
    //listObject[iObj]->MODEL = glm::rotate(listObject[iObj]->MODEL, transform.vAngle, m_right);
}
